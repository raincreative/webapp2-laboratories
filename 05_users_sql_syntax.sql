...
VALUES
('Leanne Graham', 'Bret', 'Sincere@april.bizm', '1-770-736-8031 x56442', 'hildegard.org'),
...
INSERT INTO addresses(street, suite, city, zipcode, lat, lang, user_id)
VALUES
('Kulas Light', 'Apt. 556', 'Gwenborough', '92998-3874', '-37.3159', '81.1496', 1),
('Victor Plains', 'Suite 87', 'Wisokyburgh', '90566-7771', '-43.9509', '-34.4618', 2),
...
INSERT INTO companies(company_name, company_catchPhrase, company_bs, user_id)
VALUES
...
('Robel-Corkery', 'Multi-tiered zero tolerance productivity', 'Multi-tiered zero tolerance productivity', 4),
